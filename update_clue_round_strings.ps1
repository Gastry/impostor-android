...
$translations = @{
    ...
    'values-ja' = @{
        ...
        round_ready_instructions = '各周で全員が1語だけ言います。決めた周回が終わったらインポスターに投票します。'
        round_ready_clue_rounds = 'このゲームの周回数: %1$d'
        round_ready_word_per_turn = '各プレイヤーは1周ごとに1語だけ言います。'
        round_ready_vote_after_rounds = '%1$d周が終わったらインポスターに投票してください。'
        ...
        how_win_line_1 = '決めた周回が終わったら、誰がインポスターか投票します。'
